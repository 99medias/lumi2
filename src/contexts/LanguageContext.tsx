...
const translations = {
  fr: {
    ...
    footer: {
      tagline: 'votre tranquillité digitale',
      description: 'Protection informatique pour les familles belges. Une équipe locale à votre écoute.',
      hours: 'Lun-Ven: 9h-18h · Urgences: 24/7',
    ...
    legal: {
      common: {
        ...
        company: 'NEXORA AI SOLUTIONS LLC',
        companyName: 'NEXORA AI SOLUTIONS LLC (MaSécurité)',
        legalForm: 'Limited Liability Company (LLC)',
        registrationNumber: 'Numéro d\'enregistrement',
        registrationNum: 'Disponible sur demande',
        formationDate: 'Date de formation',
        formationDateValue: '25 novembre 2025',
        address: 'Adresse',
        addressValue: '1509 Coffeen Ave Ste 1200, Sheridan, WY 82801, USA',
        registeredAgent: 'Membre unique',
        registeredAgentValue: 'NEXORA AI SOLUTIONS LLC',
        agentAddress: 'Adresse de l\'agent',
        agentAddressValue: '1509 Coffeen Ave Ste 1200, Sheridan, WY 82801, USA',
  ...
  en: {
    ...
    footer: {
      tagline: 'your digital peace of mind',
      description: 'IT protection for Belgian families. A local team at your service.',
      hours: 'Mon-Fri: 9am-6pm · Emergencies: 24/7',
    ...
    legal: {
      common: {
        ...
        registrationNum: 'Available upon request',
        formationDate: 'Formation date',
        formationDateValue: 'November 25, 2025',
        address: 'Address',
        addressValue: '1509 Coffeen Ave Ste 1200, Sheridan, WY 82801, USA',
        registeredAgent: 'Sole member',
        registeredAgentValue: 'NEXORA AI SOLUTIONS LLC',
  ...
  es: {
    ...
    footer: {
      tagline: 'su tranquilidad digital',
      description: 'Protección informática para familias belgas. Un equipo local a su servicio.',
      hours: 'Lun-Vie: 9h-18h · Emergencias: 24/7',
      services: 'Nuestros servicios',
      essentialProtection: 'Protección Esencial',
      familyProtection: 'Protección Familiar',
      completeProtection: 'Protección Completa',
      freeDiagnostic: 'Diagnóstico gratuito',
      emergencySupport: 'Asistencia de emergencia',
      ...
      refundPolicy: 'Garantía y Reembolso',
      rights: 'Todos los derechos reservados',
      support247: 'Asistencia 24/7',
      securePayment: 'Pago 100% seguro',
      gdprProtected: 'Datos protegidos RGPD',
      acceptedPayments: 'Pagos aceptados:',
      followUs: 'Síguenos:',
      proudlyBelgian: 'Orgullosamente belga'
    },
    testimonials: {
    ...
    legal: {
      common: {
        ...
        registrationNum: 'Disponible bajo petición',
        formationDate: 'Fecha de formación',
        formationDateValue: '25 de noviembre de 2025',
        address: 'Dirección',
        addressValue: '1509 Coffeen Ave Ste 1200, Sheridan, WY 82801, USA',
        registeredAgent: 'Miembro único',
        registeredAgentValue: 'NEXORA AI SOLUTIONS LLC',
