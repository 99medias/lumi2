...
INSERT INTO testimonials (name, role, company, rating, comment, product, featured, verified, location) VALUES
  ('Sophie Martin', 'Directrice Marketing', 'TechCorp France', 5, 'MaSecuVPN Pro a complètement transformé notre façon de travailler en déplacement. La connexion est ultra-rapide et nous nous sentons en sécurité sur tous les réseaux Wi-Fi publics. Un must-have pour toute entreprise !', 'vpn', true, true, 'Paris, France'),
  ...
  ('Thomas Bernard', 'Chef de Projet IT', NULL, 5, 'La protection complète de MaSécurité nous a évité plusieurs attaques cette année. Le support client est réactif et professionnel. Je recommande à 100% !', 'general', true, true, 'Toulouse, France'),
  ...
  ('Isabelle Moreau', 'Responsable RH', NULL, 5, 'J''ai essayé plusieurs VPN avant MaSécurité. Celui-ci est de loin le meilleur : rapide, fiable, et le service client est top. Parfait pour le télétravail.', 'vpn', true, true, 'Strasbourg, France'),
  ...
  ('Alexandre Roux', 'Directeur Financier', 'FinTech Solutions', 5, 'La sécurité n''est pas négociable dans notre secteur. MaSécurité répond à toutes nos exigences de conformité RGPD. Service impeccable.', 'general', true, true, 'Paris, France');
